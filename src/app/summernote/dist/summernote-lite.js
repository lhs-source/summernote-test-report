...
function splitTree(root, point, options) {
  ...
  console.log('root', point, ancestors);
  if (!ancestors.length) {
    return null;
  ...
  if (ancestors.length > 2) {
    ...
    console.log('ifHasNextSibling', ifHasNextSibling);
    if (ifHasNextSibling && point.offset != 0 && isRightEdgePoint(point)) {
      var nestSibling = ifHasNextSibling.nextSibling;
      var textNode;
      console.log('nestSibling', nestSibling);
      console.log('nestSibling.nodeType', nestSibling.nodeType);
  ...
  return ancestors.reduce(function (node, parent) {
    console.log('ancestors.reduce', node, parent);
    if (node === point.node) {
  ...
  return range_createClass(WrappedRange, [{
    ...
    value: function nativeRange() {
      if (env.isW3CRangeSupport) {
        ...
        console.log('here1', this.sc, this.so, this.ec, this.eo);
